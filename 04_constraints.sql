...
-- UNIQUE CONSTRAINTS (evitar nombres repetidos en atributos categóricos)
...
-- CHECK CONSTRAINTS
-- Validación para odómetro positivo
ALTER TABLE VEHICLES ADD CONSTRAINT CHK_ODOMETER_POSITIVE CHECK (ODOMETER >= 0);

-- Validación para año válido (comentado, puede activarse si se necesita)
-- ALTER TABLE VEHICLES ADD CONSTRAINT CHK_YEAR_VALID 
--    CHECK (YEAR BETWEEN 1900 AND EXTRACT(YEAR FROM SYSDATE));
